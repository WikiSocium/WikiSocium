...
1. Клонируете master бранч себе локально
2. Делаете локальный бранчи со своими текущими задачами
...
3. Переключаетесь на master, делаете merge с бранчем готовой задачи
4. Делаете push в удаленный репозиторий (тут мне пока не совсем понятно, есть ли возможность коллабораторам делать пуш в master, проверьте кто-нибудь!)