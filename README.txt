...
4. Теперь надо склонировать репозиторий, перейти в папку node и установить необходимые пакеты.
5. В директории с app.js (у нас это node сейчас) надо выполнить "npm install" (то есть установить все зависимости из package.json)
